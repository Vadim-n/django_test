...
class Room(models.Model):
    """Модель комнаты чата"""
    creator = models.ForeignKey(User, verbose_name="Создатель чата", on_delete=models.CASCADE)
    invited_users = models.ManyToManyField(User, verbose_name="Участники чата", related_name='invited_users')
